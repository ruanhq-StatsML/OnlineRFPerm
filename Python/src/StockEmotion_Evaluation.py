...
MODEL_REGISTRY = model_factory.as_r_style_dict()
df_train = pd.read_csv("Real_Data/Stock_Emotion/train_stockemo_df.csv").drop(['Unnamed: 0'], axis = 1)
df_val = pd.read_csv("Real_Data/Stock_Emotion/val_stockemo_df.csv").drop(['Unnamed: 0'], axis = 1)
df_test = pd.read_csv("Real_Data/Stock_Emotion/test_stockemo_df.csv").drop(['Unnamed: 0'], axis = 1)

df_whole = np.vstack([df_train, df_val, df_test])

df_whole = np.array(df_whole)

result = []
result_xgb1 = onlinePermOOB_wholedf(df_whole,
    model_registry = MODEL_REGISTRY,
...
result_rf1 = onlinePermOOB_wholedf(df_whole,
    model_registry = MODEL_REGISTRY,
    model_m =  'rf_regressor',
    ref_batch_size = 1000, 
    batch_size = 10, 
...
result_mlp1 = onlinePermOOB_wholedf(df_whole,
    model_registry = MODEL_REGISTRY,
...
result_xgb2 = onlinePermOOB_wholedf(df_whole[1000:, :],
    model_registry = MODEL_REGISTRY,
    model_m = 'xgb_regressor',
    ref_batch_size = 1000, 
    batch_size = 10, 
...
result.append(result_xgb2)
result_rf2 = onlinePermOOB_wholedf(df_whole[1000:, :],
    model_registry = MODEL_REGISTRY,
    model_m =  'rf_regressor',
    ref_batch_size = 1000, 
    batch_size = 10, 
...
result.append(result_rf2)
result_mlp2 = onlinePermOOB_wholedf(df_whole[1000:, :],
    model_registry = MODEL_REGISTRY,
    model_m =  'mlp_regressor',
    ref_batch_size = 1000, 
    batch_size = 10, 
...
result.append(result_mlp2)
cols = ['BOCPD_SUM', 'BOCPD_bcpd_2', 'BOCPD_bcpd_1', 'BOCPD_bcpd_3', 'EWMA_SUM', 'EWMA_3', 'EWMA_2', 'EWMA_1', 'TS_SUM', 'TS_3', 'TS_2', 'TS_1', 'ADWIN_SUM', 'ADWIN_3', 'ADWIN_2', 'ADWIN_1', 'HDMMA_SUM', 'HDMMA_3', 'HDMMA_2', 'HDMMA_1', 'ECDDWT_SUM', 'ECDDWT_3', 'ECDDWT_2', 'HalfSpaceTrees_SUM', 'HalfSpaceTrees_1', 'HalfSpaceTrees_2', 'HalfSpaceTrees_3', 'martingale_SUM', 'martingale2_SUM', 'martingale_1', 'martingale_2', 'martingale_3', 'martingale2_1', 'martingale2_2', 'martingale2_3', 'fix_SUM', 'fix_1', 'fix_2', 'fix_3', 'addis_SUM', 'addis_1', 'addis_2', 'addis_3', 'saffron_SUM', 'saffron_1', 'saffron_2', 'saffron_3', 'DDM_SUM', 'DDM_1', 'DDM_2', 'DDM_3', 'STEPD_SUM', 'STEPD_1', 'STEPD_2', 'STEPD_3', 'HDDMA_SUM', 'HDDMA_1', 'HDDMA_2', 'HDDMA_3', 'ECDDWT_1']
pd.DataFrame(result, columns = cols).to_csv("stockemotion_onlinePermOOB_result_b10.csv")





#How would you distinguish it's noise or?
