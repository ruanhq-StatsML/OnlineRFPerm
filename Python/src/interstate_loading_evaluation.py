...
MODEL_REGISTRY = model_factory.as_r_style_dict()
df_interstate = pd.read_csv("Real_Data/Load_Traffic_Data/interstate_loading_data.csv").drop(['Unnamed: 0'], axis = 1)
df_interstate = np.array(df_interstate)[:, :(df_interstate.shape[1] - 1)]
df_ref1 = np.array(df_interstate[:10000, :])
df_ref2 = np.array(df_interstate[1000:10000, :])
df_interstate = np.array(df_interstate)
result = []
result_xgb1 = onlinePermOOB_wholedf(df_ref1,
    model_registry = MODEL_REGISTRY,
...
result_rf1 = onlinePermOOB_wholedf(df_ref1,
    model_registry = MODEL_REGISTRY,
    model_m =  'rf_regressor',
    ref_batch_size = 1000, 
    batch_size = 10, 
...
result_mlp1 = onlinePermOOB_wholedf(df_ref1,
    model_registry = MODEL_REGISTRY,
...
result_xgb2 = onlinePermOOB_wholedf(df_ref2,
    model_registry = MODEL_REGISTRY,
    model_m = 'xgb_regressor',
    ref_batch_size = 1000, 
    batch_size = 10, 
...
result_rf2 = onlinePermOOB_wholedf(df_ref2,
    model_registry = MODEL_REGISTRY,
    model_m =  'rf_regressor',
    ref_batch_size = 1000, 
    batch_size = 10, 
...
result_mlp2 = onlinePermOOB_wholedf(df_ref2,
    model_registry = MODEL_REGISTRY,
    model_m =  'mlp_regressor',
    ref_batch_size = 1000, 
    batch_size = 10, 
...
pd.DataFrame(result).to_csv("interstate_loading_onlinePermOOB_result_b10.csv")



#Build a binary classifier pipeline here.
#result.append(result_mlp2)
#result.append(result_rf2)
